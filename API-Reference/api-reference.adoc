...
API interface `sign-transaction`, code https://github.com/EIYARO-Project/core/blob/main/api/hsm.go#L53[api/hsm.go#L53,window=_blank]
...
API interface `submit-transaction`, code https://github.com/EIYARO-Project/core/blob/main/api/transact.go#L132[api/transact.go#L132,window=_blank]
