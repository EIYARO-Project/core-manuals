...
Information about these fields of the utxo above can be found in the transaction that the `get-block` interface returns the result of, and its related structure is as follows: (refer to the code https://github.com/EIYARO-Project/core/blob/master/api/block_retrieve.go#L29[core/api/block_retrieve.go#L29,window=_blank])
[source,go]
----
...
The first step is to construct the transaction input `TxInput` and the data information needed for signing `SigningInstruction` through `utxo`, this part of the function can refer to the code https://github.com/EIYARO-Project/core/blob/master/account/builder.go#L305[core/account/builder.go#L305,window=_blank] can be modified accordingly as follows.
[source,go]
----
...
This part of the function can be found in the code https://github.com/EIYARO-Project/core/blob/master/protocol/bc/types/txoutput.go#L20[core/protocol/bc/types/txoutput.go#L20].
[source,go]
----
...
Construct a transaction `txbuilder.Template` from the transaction information already generated above, the function of this part can refer to https://github.com/EIYARO-Project/core/blob/master/blockchain/txbuilder/builder.go#L96[core/blockchain/txbuilder/builder.go#L96,window=_blank] to transform it to.
[source,go]
----
...
There is no need to change anything in this step, just refer to the `API` link:#_submit_transaction_endpoint[submit-transaction].