...
API interface `build-transaction`, code https://github.com/EIYARO-Project/core/blob/main/api/transact.go#L114[core/api/transact.go#L114, window=_blank]
...
API interface sign-transaction, code https://github.com/EIYARO-Project/core/blob/main/api/hsm.go#L52[api/hsm.go#L52,window=_blank]
